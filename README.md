...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Importing Data</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Defining configuration options</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">ImageDataGenerators</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 1: Creating a test_generator using the test_datagen object</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Let's look at a few augmented images</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Pre-Trained Models / VGG-16</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Model Summary</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 2: Compile the Model</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Callback function with Learning Rate Scheduler</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 3: Fit and train the model</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 4: Plot loss curves for training and validation sets (extract_feat_model)</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 5: Plot accuracy curves for training and validation sets (extract_feat_model)</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 7: Plot loss curves for training and validation sets (fine-tune model)</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 8: Plot accuracy curves for training and validation sets (fine tune model)</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 9: Evaluate both models on test data</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 10: Plot a test image using Extract Features Model (index_to_plot = 1)</h2>
...
<h2 style="font-size: 2em; margin: 20px 0; border-bottom: 2px solid;">Step 11: Plot a test image using Fine-Tuned Model (index_to_plot = 1)</h2>
